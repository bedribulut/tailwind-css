  ...
  return (
    <div className="flex flex-col items-stretch px-3 justify-between mb-6 md:grid md:gap-4 md:grid-cols-3 md:grid-rows-3 md:px-0">
      {ongoingProjects.map((project) => (
        <div key={project.id} className="relative flex flex-col mt-6 items-center justify-between w-full h-screen bg-cover bg-center bg-opacity-50 rounded-lg" style={{ backgroundImage: `url(${project.imgSrc})`}}>
